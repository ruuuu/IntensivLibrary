...
var getStars = function getStars(raiting) {
  ...
  for (var i = 0; i < 5; i++) {
    if (i === 0) {
      // если 1 ая звездочка
      stars.push("<img class=\"cart__rating-star\" src=\"img/Star.svg\" alt=\"\u0420\u0435\u0439\u0442\u0438\u043D\u0433 ".concat(raiting, " \u0438\u0437 5\">"));
    } else if (i < raiting) {
...
var container = document.querySelector('.book__container'); // <div class="book__container"> </div>
...
var renderBook_getStars = function getStars(raiting) {
  ...
  for (var i = 0; i < 5; i++) {
    if (i === 0) {
      // если 1 ая звездочка
      stars.push("<img class=\"book__rating-star\" src=\"img/Star.svg\" alt=\"\u0420\u0435\u0439\u0442\u0438\u043D\u0433 ".concat(raiting, " \u0438\u0437 5\">"));
    } else if (i < raiting) {
...
var addBtns = document.querySelectorAll('.header__btn-add, .library__add-btn'); // массив кнопок Добавить
...
router_router.on({
  ...
  'book': function book(_ref) {
    ...
    // если в адресной строке будет написано book, то вызовется эта фукния
...
/* harmony default export */ const modules_toBase64 = (toBase64);
;// CONCATENATED MODULE: ./src/js/modules/upload.js



var label = document.querySelector('.upload__label');
var preview = document.querySelector('.upload__preview'); // <img>
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          // тк возаращает промис, то ждем когда придет результат(await)
...
;// CONCATENATED MODULE: ./src/js/modules/changeField.js


function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = changeField_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }

function changeField_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return changeField_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return changeField_arrayLikeToArray(o, minLen); }

function changeField_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }


 //  импорт объекта router из router.js




var fileldsets = document.querySelectorAll('.add__fileldset'); // [fieldset, fieldset,fieldset]

var addBtn = document.querySelector('.add__btn'); //  кнопка Далее

var changeField_form = document.querySelector('.add__form'); // форма
//console.log(addBtn.dataset.count);

var otherBackBtn = document.querySelector('.other-class'); // кнопка Назад
  ...
  var _ref = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
    ...
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            formData = new FormData(changeField_form); //полуим  колеккцию котрую можн вытащить из любой формы,  у полей формы долен быть name

            data = Object.fromEntries(formData); // name у полей станут свойствами объекта, а value у полей станут значениям свойств
          ...
          case 5:
            ...
            // ждем когда операция выпонлится
            console.log(data);
            _context.next = 9;
          ...
          case 9:
            ...
            if (data) {
              changeField_form.reset(); // очищаем форму
...
var initFieldSet = function initFieldSet() {
  ...
  addBtn.addEventListener('click', function (_ref2) {
    ...
    // target -свойство  внутри объекта evt, dsdtltn элемнет, на который нажали
    var fieldset = fileldsets[count]; // получим fieldset на котром находимся
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (!elem.checkValidity()) {
          // если элемент невалидный, выделяем поля красным border
...
;// CONCATENATED MODULE: ./src/js/index.js
 ...
 // импорт фукнции changeFieldset из файла changeField.js
...
changeFieldset(); // const five = document.querySelectorAll('.book__rating-star');
