...
router.on({
  ...
  'book': function book(_ref) {
    ...
    search.classList.remove('search__active');
    document.body.classList.add('body__gradient'); // вызвать фкцию котрая отрисует книжу
  },
...
var libraryList = document.querySelector('.library__list'); // <ul> </ul>
...
renderListBooks(); // отображенеи спсика книг на главной

renderBook(); // отобраение книги на странице book
